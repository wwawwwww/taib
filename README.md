...
`База канала` - это не счетчик публикаций и не сегодняшняя активность. Это заменяемый корпус старых сообщений, по которому бот подстраивает голос. При новой загрузке старая база очищается.
