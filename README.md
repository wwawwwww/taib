...
- использует локальную память и историю постов;
- может публиковать спонтанные посты с минимальной паузой;
- умеет импортировать старые посты канала из файла;
...
- посмотреть preview автопоста;
- форсировать автопост прямо сейчас;
- синхронизировать память с Telegram updates;
- импортировать старые посты;
- посмотреть память канала.
...
- открыть список измененных файлов и diff;
- сделать preview поста по контексту;
- опубликовать такой пост сразу;
- вручную зафиксировать checkpoint.
...
Если хочешь, чтобы бот помнил старые посты канала, импортируй архив:
